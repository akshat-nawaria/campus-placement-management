...
const {issueOffer, bulkIssueOffers, acceptOffer, getMyOffer, getAllOffers} = require("../controllers/offer.controller")
...
router.post("/bulk-issue", requireRole([ROLES.ADMIN, ROLES.TPO]), bulkIssueOffers);
