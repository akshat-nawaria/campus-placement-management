        ...
        <div className="bg-white rounded-xl border border-[#E2E8F0] shadow-[0px_1px_3px_rgba(15,23,42,0.08)] p-6">
          ...
          {student ? (
            <div className="space-y-5">
              ...
              {student.resumeUrl && (
                <a href={student.resumeUrl.startsWith('http') ? student.resumeUrl : `${import.meta.env.VITE_API_BASE_URL}${student.resumeUrl.startsWith('/') ? '' : '/'}${student.resumeUrl}`} target="_blank" rel="noreferrer"
